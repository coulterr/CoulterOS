...
bin/RileyOS.bin: obj/kernel_ep.o obj/kernel.o obj/ps2_driver.o obj/vga_driver.o obj/utils.o obj/char_queue.o obj/mallocator.o 
	ld -m elf_i386 -Ttext 0x3B9ACA00 --oformat=binary obj/kernel_ep.o obj/kernel.o obj/ps2_driver.o obj/vga_driver.o obj/utils.o obj/char_queue.o obj/mallocator.o -o bin/RileyOS.bin
