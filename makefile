...
bin/RileyOS.bin: obj/boot_sect.o obj/bootloader.o obj/utils.o obj/ps2_driver.o obj/pio_driver.o obj/vga_driver.o obj/mallocator.o obj/char_queue.o obj/kernel.o
	ld -e start -m elf_i386 -Ttext 0x7C00 --oformat=binary obj/boot_sect.o obj/bootloader.o obj/utils.o obj/ps2_driver.o obj/pio_driver.o obj/vga_driver.o obj/mallocator.o obj/char_queue.o obj/kernel.o -o bin/RileyOS.bin
obj/kernel.o: kernel/kernel.c 
	gcc -m32 -ffreestanding -c kernel/kernel.c -o obj/kernel.o
obj/ps2_driver.o: drivers/ps2/ps2_driver.c
	gcc -m32 -ffreestanding -c drivers/ps2/ps2_driver.c -o obj/ps2_driver.o
obj/pio_driver.o: drivers/pio/pio_driver.c
	gcc -m32 -ffreestanding -c drivers/pio/pio_driver.c -o obj/pio_driver.o
obj/vga_driver.o: drivers/vga/vga_driver.c
	gcc -m32 -ffreestanding -c drivers/vga/vga_driver.c -o obj/vga_driver.o
